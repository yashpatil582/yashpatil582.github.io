...
import type { SocialIcon as IconName } from "@/data/types";

type SvgProps = React.SVGProps<SVGSVGElement>;

/* Brand glyphs as inline SVG (simple-icons paths, CC0) — lucide dropped brand
   marks, so we ship our own to keep the social row on-brand and dependency-free. */
...
export function SocialGlyph({ name, ...props }: { name: IconName } & SvgProps) {
  switch (name) {
    case "github":
